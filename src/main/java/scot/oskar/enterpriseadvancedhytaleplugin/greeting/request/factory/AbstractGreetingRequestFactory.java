...
public abstract class AbstractGreetingRequestFactory implements GreetingRequestFactory {

  @Override
  @Nonnull
  public abstract GreetingRequest create(@Nonnull PlayerIdentity recipient,
